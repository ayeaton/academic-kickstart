...
file = gsub(pattern = "\\.Rmarkdown$", "", filename)
path = paste0("../../static/post/", file, "_files/figure-html/")
dir.create(path)
...
<iframe width="1500" height="1000" scrolling="no" frameborder="no"  src="https://herewego.shinyapps.io/kmeans/"> </iframe> 
...
```{r echo=FALSE}
pca <- prcomp(iris_data) # run pca
pcs <- pca$x # extract principal components 
```
